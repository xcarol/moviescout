          ...
          children: [
            Expanded(
              child: TextField(
                ...
                maxLines: _isNluMode ? 4 : 1,
                textInputAction: TextInputAction.search,
                decoration: InputDecoration(
                  hintText: _isNluMode ? 'Cerca amb llenguatge natural...' : AppLocalizations.of(context)!.search,
                      ...
                      Consumer<NluService>(
                        builder: (context, nluService, child) {
                          return IconButton(
                            icon: Icon(
                              Icons.auto_awesome,
                              color: _isNluMode ? colorScheme.primary : textColor.withValues(alpha: 0.5),
                              size: 24,
                            ),
                            tooltip: 'Cerca Intel·ligent',
                            onPressed: () {
                              if (!nluService.assetsDownloaded) {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => const NluSettingsScreen(),
                                  ),
                                ).then((_) {
                                  if (nluService.assetsDownloaded) {
                                    setState(() {
