...
const TmdbTitleSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'omdbRatingsJson': PropertySchema(
      id: 34,
      name: r'omdbRatingsJson',
      type: IsarType.string,
    ),
...
int _tmdbTitleEstimateSize(
  ...
  bytesCount += 3 + object.inLists.length * 3;
  {
    for (var i = 0; i < object.inLists.length; i++) {
      final value = object.inLists[i];
  ...
  {
    final value = object.omdbRatingsJson;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
...
void _tmdbTitleSerialize(
  ...
  writer.writeStringList(offsets[15], object.inLists);
  ...
  writer.writeStringList(offsets[35], object.originCountry);
  writer.writeString(offsets[36], object.originalLanguage);
  writer.writeString(offsets[37], object.originalName);
  writer.writeString(offsets[38], object.overview);
  writer.writeDouble(offsets[39], object.popularity);
  writer.writeString(offsets[40], object.posterPath);
  writer.writeString(offsets[41], object.posterPathSuffix);
  writer.writeString(offsets[42], object.providersJson);
  writer.writeDouble(offsets[43], object.rating);
  writer.writeString(offsets[44], object.recommendationsJson);
  writer.writeString(offsets[45], object.releaseDate);
  writer.writeLong(offsets[46], object.revenue);
  writer.writeLong(offsets[47], object.runtime);
  writer.writeString(offsets[48], object.seasonsJson);
  writer.writeString(offsets[49], object.status);
  writer.writeString(offsets[50], object.tagline);
  writer.writeLong(offsets[51], object.tmdbId);
  writer.writeString(offsets[52], object.videosJson);
  writer.writeDouble(offsets[53], object.voteAverage);
  writer.writeLong(offsets[54], object.voteCount);
}
...
TmdbTitle _tmdbTitleDeserialize(
  ...
  final object = TmdbTitle(
    ...
    originCountry: reader.readStringList(offsets[35]) ?? const [],
    originalLanguage: reader.readStringOrNull(offsets[36]) ?? '',
    originalName: reader.readStringOrNull(offsets[37]) ?? '',
    overview: reader.readStringOrNull(offsets[38]) ?? '',
    popularity: reader.readDoubleOrNull(offsets[39]) ?? 0.0,
    posterPathSuffix: reader.readStringOrNull(offsets[41]),
    providersJson: reader.readStringOrNull(offsets[42]),
    rating: reader.readDoubleOrNull(offsets[43]) ?? 0.0,
    recommendationsJson: reader.readStringOrNull(offsets[44]),
    releaseDate: reader.readStringOrNull(offsets[45]) ?? '',
    revenue: reader.readLongOrNull(offsets[46]) ?? 0,
    runtime: reader.readLongOrNull(offsets[47]) ?? 0,
    seasonsJson: reader.readStringOrNull(offsets[48]),
    status: reader.readStringOrNull(offsets[49]) ?? '',
    tagline: reader.readStringOrNull(offsets[50]) ?? '',
    tmdbId: reader.readLong(offsets[51]),
    videosJson: reader.readStringOrNull(offsets[52]),
    voteAverage: reader.readDoubleOrNull(offsets[53]) ?? 0.0,
    voteCount: reader.readLongOrNull(offsets[54]) ?? 0,
  );
  object.inLists = reader.readStringList(offsets[15]) ?? [];
  return object;
}
...
extension TmdbTitleByIndex on IsarCollection<TmdbTitle> {
  Future<TmdbTitle?> getByTmdbIdMediaType(int tmdbId, String mediaType) {
    return getByIndex(r'tmdbId_mediaType', [tmdbId, mediaType]);
  }

  TmdbTitle? getByTmdbIdMediaTypeSync(int tmdbId, String mediaType) {
    return getByIndexSync(r'tmdbId_mediaType', [tmdbId, mediaType]);
  }

  Future<bool> deleteByTmdbIdMediaType(int tmdbId, String mediaType) {
    return deleteByIndex(r'tmdbId_mediaType', [tmdbId, mediaType]);
  }

  bool deleteByTmdbIdMediaTypeSync(int tmdbId, String mediaType) {
    return deleteByIndexSync(r'tmdbId_mediaType', [tmdbId, mediaType]);
  }

  Future<List<TmdbTitle?>> getAllByTmdbIdMediaType(
      List<int> tmdbIdValues, List<String> mediaTypeValues) {
    final len = tmdbIdValues.length;
    assert(mediaTypeValues.length == len,
  ...
  List<TmdbTitle?> getAllByTmdbIdMediaTypeSync(
      List<int> tmdbIdValues, List<String> mediaTypeValues) {
    final len = tmdbIdValues.length;
    assert(mediaTypeValues.length == len,
        'All index values must have the same length');
  ...
  Future<Id> putByTmdbIdMediaType(TmdbTitle object) {
    return putByIndex(r'tmdbId_mediaType', object);
  }

  Id putByTmdbIdMediaTypeSync(TmdbTitle object, {bool saveLinks = true}) {
    return putByIndexSync(r'tmdbId_mediaType', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByTmdbIdMediaType(List<TmdbTitle> objects) {
    return putAllByIndex(r'tmdbId_mediaType', objects);
  }

  List<Id> putAllByTmdbIdMediaTypeSync(List<TmdbTitle> objects,
      {bool saveLinks = true}) {
    return putAllByIndexSync(r'tmdbId_mediaType', objects,
        saveLinks: saveLinks);
  }
}
...
extension TmdbTitleQueryWhere
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterWhereClause>
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterWhereClause> tmdbIdMediaTypeEqualTo(
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterWhereClause>
      tmdbIdEqualToMediaTypeNotEqualTo(int tmdbId, String mediaType) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
...
extension TmdbTitleQueryFilter
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterFilterCondition>
      inListsElementContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'inLists',
        value: value,
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterFilterCondition>
      inListsElementMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'inLists',
        wildcard: pattern,
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterFilterCondition>
      inListsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'inLists',
        length,
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterFilterCondition> inListsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'inLists',
        0,
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterFilterCondition> isMiniSerieEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isMiniSerie',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterFilterCondition>
      lastProvidersUpdateEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lastProvidersUpdate',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterFilterCondition>
      lastProvidersUpdateGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterFilterCondition>
      lastProvidersUpdateContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'lastProvidersUpdate',
        value: value,
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterFilterCondition>
      lastProvidersUpdateMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'lastProvidersUpdate',
        wildcard: pattern,
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterFilterCondition>
      omdbRatingsJsonIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'omdbRatingsJson',
      ));
    });
  }

  QueryBuilder<TmdbTitle, TmdbTitle, QAfterFilterCondition>
      omdbRatingsJsonIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'omdbRatingsJson',
      ));
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterFilterCondition>
      omdbRatingsJsonContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'omdbRatingsJson',
        value: value,
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterFilterCondition>
      omdbRatingsJsonMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'omdbRatingsJson',
        wildcard: pattern,
...
extension TmdbTitleQuerySortBy on QueryBuilder<TmdbTitle, TmdbTitle, QSortBy> {
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterSortBy> sortByIsMiniSerie() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isMiniSerie', Sort.asc);
    });
  }

  QueryBuilder<TmdbTitle, TmdbTitle, QAfterSortBy> sortByIsMiniSerieDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isMiniSerie', Sort.desc);
    });
  }
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterSortBy> sortByLastProvidersUpdate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastProvidersUpdate', Sort.asc);
    });
  }

  QueryBuilder<TmdbTitle, TmdbTitle, QAfterSortBy>
      sortByLastProvidersUpdateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastProvidersUpdate', Sort.desc);
    });
  }
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterSortBy> sortByOmdbRatingsJson() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'omdbRatingsJson', Sort.asc);
    });
  }

  QueryBuilder<TmdbTitle, TmdbTitle, QAfterSortBy> sortByOmdbRatingsJsonDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'omdbRatingsJson', Sort.desc);
    });
  }
...
extension TmdbTitleQuerySortThenBy
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterSortBy> thenByIsMiniSerie() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isMiniSerie', Sort.asc);
    });
  }

  QueryBuilder<TmdbTitle, TmdbTitle, QAfterSortBy> thenByIsMiniSerieDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isMiniSerie', Sort.desc);
    });
  }
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterSortBy> thenByLastProvidersUpdate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastProvidersUpdate', Sort.asc);
    });
  }
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QAfterSortBy> thenByOmdbRatingsJson() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'omdbRatingsJson', Sort.asc);
    });
  }

  QueryBuilder<TmdbTitle, TmdbTitle, QAfterSortBy> thenByOmdbRatingsJsonDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'omdbRatingsJson', Sort.desc);
    });
  }
...
extension TmdbTitleQueryWhereDistinct
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QDistinct> distinctByInLists() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'inLists');
    });
  }

  QueryBuilder<TmdbTitle, TmdbTitle, QDistinct> distinctByIsMiniSerie() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isMiniSerie');
    });
  }
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QDistinct> distinctByLastProvidersUpdate(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'lastProvidersUpdate',
          caseSensitive: caseSensitive);
    });
  }
  ...
  QueryBuilder<TmdbTitle, TmdbTitle, QDistinct> distinctByOmdbRatingsJson(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'omdbRatingsJson',
          caseSensitive: caseSensitive);
    });
  }
...
extension TmdbTitleQueryProperty
  ...
  QueryBuilder<TmdbTitle, List<String>, QQueryOperations> inListsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'inLists');
    });
  }

  QueryBuilder<TmdbTitle, bool, QQueryOperations> isMiniSerieProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isMiniSerie');
    });
  }
  ...
  QueryBuilder<TmdbTitle, String, QQueryOperations>
      lastProvidersUpdateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'lastProvidersUpdate');
    });
  }
  ...
  QueryBuilder<TmdbTitle, String?, QQueryOperations> omdbRatingsJsonProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'omdbRatingsJson');
    });
  }
