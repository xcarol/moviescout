...
class WatchlistUpdateService {
  static final WatchlistUpdateService _instance =
      WatchlistUpdateService._internal();

  factory WatchlistUpdateService() {
    return _instance;
  }
  ...
  Future<void> checkForUpdates() async {
    ...
    try {
      ...
      for (final title in allTitlesToScan) {
        ...
        updatedCount++;
        final notified = await _updateTitle(
            title,
            logLines,
            providersList,
            enabledProviderIds,
